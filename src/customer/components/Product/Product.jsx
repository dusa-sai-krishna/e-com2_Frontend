...
export default function Product() {
    ...
    const pageNumberValue = searchParams.get("page") || 1; //if not found, by default 1
    ...
    useEffect(() => {
        ...
        const data={
            ...
            pageNumber: pageNumberValue-1 || 0, // zero based indexing,
            pageSize: 10,
            stock: stock || "in_stock"
        }

        console.log("This data is dispatched from Products.jsx",data)
                    ...
                    <section aria-labelledby="products-heading" className="pb-24 pt-6">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                            ...
                            <form className="hidden lg:block">
                                <h1 className="text-left text-lg text-gray-400">Filters</h1>
                                {filters.map((section) => (
                          ...
                          <MinusIcon aria-hidden="true" className="size-5 group-[&:not([data-open])]:hidden" />
                                ...
                                {singleFilter.map((section) => (
                                    <Disclosure key={section.id} as="div" className="border-b border-gray-200 py-6">
                                        <h3 className="-my-3 flow-root">
                                            <DisclosureButton className="group flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
                                                <FormLabel sx={{color:"#000"}} className="font-medium text-gray-900" id={`radio-group-label-${section.id}`}>
                                                    {section.name}
                                                </FormLabel>
                                                <span className="ml-6 flex items-center">
                    <PlusIcon aria-hidden="true" className="size-5 group-data-[open]:hidden" />
                    <MinusIcon aria-hidden="true" className="size-5 group-[&:not([data-open])]:hidden" />
                                        ...
                                        <DisclosurePanel className="pt-6">
                                            <div className="space-y-4">
                                                <FormControl>
                                                    <RadioGroup
                                                        aria-labelledby={`radio-group-label-${section.id}`}
                            ...
                            <div className="lg:col-span-4">
                                <div className="flex flex-wrap justify-center bg-white py-5">
                                    {product && product.products?.content?.map((item)=>(<ProductCard product={item}/>))}
                                </div>
                            </div>
                        </div>
                    </section>
