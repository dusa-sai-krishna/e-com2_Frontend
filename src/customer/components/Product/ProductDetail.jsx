    ...
    return (
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                ...
                {/*Product Details*/}
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-10 pt-10">
                    {/* Image gallery */}
                ...
                <section>
                    ...
                    <div className="border p-5">
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                <h1 className="text-xl font-semibold pb-1 text-left">Product Ratings</h1>
                                <div className="flex items-center space-x-3">
                                    <Rating value={4.6} precision={.5} readOnly/>
                                    <p className="opacity-60 text-left">54890 Ratings</p>
                                </div>
                                <Box className="mt-5 space-y-3">
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7,color:"blue"}} variant="determinate" value={60}  />
                                        </Grid>
                                    </Grid>
                                    <Grid container alignItems="center" gap={2}>
                                        <Grid item xs={2}>
